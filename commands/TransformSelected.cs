...
namespace TransformElementSample
{
  ...
  [CommandMeta("Any")]
  public class TransformSelected : IExternalCommand
  {
  ...
  // It loads and saves the last values to %APPDATA%\revit-ballet\runtime\TransformElement.
  ...
  public class TransformForm : WinForms.Form
  {
    ...
    public TransformForm(bool onlyViewDependent, bool disableY, bool hostedOnWall)
    {
      ...
      settingsFilePath = Path.Combine(folder, "TransformElement");
