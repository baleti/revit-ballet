    ...
    public class HandFlipSelectedDoors : IExternalCommand
    {
            ...
            ElementSet elements)
        {
            ...
            try
            {
                ...
                {
                    TaskDialog.Show("Flip Door Hands", "No elements selected. Please select one or more doors.");
                ...
                if (doors.Count == 0)
                {
                    TaskDialog.Show("Flip Door Hands", "No doors found in the selection. Please select one or more doors.");
                    return Result.Cancelled;
                }
